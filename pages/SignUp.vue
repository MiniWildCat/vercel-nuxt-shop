  ...
  <div class="sign-up" @click='$refs.verify.show = false'>
    ...
    <div class="login-container">
        ...
        >
          ...
          <FormItem><span class="color999 ml_20">点击注册，表示您同意《<router-link to="/article?id=1371992704333905920" target="_self">商城用户协议</router-link>》</span></FormItem>
        </Form>
        <!-- 拼图验证码 -->
        <Verify
          ref="verify"
    ...
    <div class="foot">
      <Row type="flex" justify="space-around" class="help">
        <router-link to="/article" class="item" target="_self">帮助</router-link>
        <router-link to="/article?id=1371779927900160000" class="item" target="_self">隐私</router-link>
        <router-link to="/article?id=1371992704333905920" class="item" target="_self">条款</router-link>
      </Row>
      <Row type="flex" justify="center" class="copyright">
        Copyright © {{year}} - Present
        <a href="https://pickmall.cn" target="_self" style="margin: 0 5px">{{config.title}}</a>
        版权所有
      </Row>
    </div>
  </div>
