...
export const buyerUrl =
  process.env.NODE_ENV === 'development'
    ? process.env.API_DEV.buyer
    : process.env.API_PROD.buyer;
export const commonUrl =
  process.env.NODE_ENV === 'development'
    ? process.env.API_DEV.common
    : process.env.API_PROD.common;
export const managerUrl =
  process.env.NODE_ENV === 'development'
    ? process.env.API_DEV.manager
    : process.env.API_PROD.manager;
export const sellerUrl =
  process.env.NODE_ENV === 'development'
    ? process.env.API_DEV.seller
    : process.env.API_PROD.seller;
// 创建axios实例
...
service.interceptors.request.use(
  config => {
    ...
    // config.headers.token = Storage.getItem("accessToken")
    if (isPutPost && isJson) {
...
//     if (!lock) {
//       lock = true;
//       console.log("初始化",oldRefreshToken)
...
//       console.log("现在有Storage",Storage)
//       // resolve('success');
//       // 一直看lock,直到请求失败或者成功
